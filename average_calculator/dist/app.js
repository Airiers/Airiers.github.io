...
(_a = document.querySelector("#addNote")) === null || _a === void 0 ? void 0 : _a.addEventListener("click", (e) => {
    e.preventDefault();
...
(_b = document.querySelector("#export")) === null || _b === void 0 ? void 0 : _b.addEventListener("click", (e) => {
    e.preventDefault();
    if (notesList && textArea) {
        textArea.value = JSON.stringify(notesList.notes, null, 2);
    }
});
(_c = document.querySelector("#import")) === null || _c === void 0 ? void 0 : _c.addEventListener("click", (e) => {
    e.preventDefault();
